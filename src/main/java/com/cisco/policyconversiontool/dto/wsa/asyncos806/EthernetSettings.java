...
@XmlRootElement(name = "ethernet_settings")
public class EthernetSettings {

    protected List<Ethernet> ethernet;
     ...
     * This is why there is not a <CODE>set</CODE> method for the ethernet property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEthernet().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<Ethernet> getEthernet() {
        if (ethernet == null) {
            ethernet = new ArrayList<Ethernet>();
        }
