...
public class ConsoleManager {
	...
	public void acceptParameter(WSAMigrationPageInfo pageInfo,WSAMigrationParameters wsaMigrationParameters) throws ParseException, IOException {
...
//		return wsaMigrationParameters;
	...
	public boolean acceptSourceVendor(WSAMigrationParameters wsaMigrationParameters,WSAMigrationPageInfo pageInfo) throws IOException{
	...
	public boolean acceptTargetVendor(WSAMigrationParameters wsaMigrationParameters,WSAMigrationPageInfo pageInfo) throws IOException{
		if (scanner.next().trim().equalsIgnoreCase("y")){
			for(Vendor Vendor:pageInfo.getTargetVendorList()){
				printAcceptMessage("\n VendorId- "+Vendor.getId()+"	Vendor Name- "+Vendor.getName()+"	Vendor Description- "+Vendor.getDesc());
				}
